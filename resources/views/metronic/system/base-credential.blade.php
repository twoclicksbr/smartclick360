...
<base href="../../../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comapps/ecommerce/sales/listing.html" />
							...
							<div class="d-flex flex-column flex-row-fluid">
								...
								<div class="d-flex align-items-center pt-1">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-white fw-bold lh-1">eCommerce</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<i class="ki-outline ki-right fs-7 text-gray-700 mx-n1"></i>
								...
								<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
									...
									<div class="page-title me-5">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Orders Listing 
										<!--begin::Description-->
										<span class="page-desc text-gray-600 fw-semibold fs-6 pt-3">Page Description</span>
										<!--end::Description--></h1>
										<!--end::Title-->
									</div>
									<!--end::Page title-->
												...
												<tbody class="fw-semibold text-gray-600">
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14436</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-24">
															<span class="fw-bold">24/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-27">
															<span class="fw-bold">27/04/2025</span>
														</td>
														<td class="text-end">
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14437</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-21">
															<span class="fw-bold">21/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-26">
															<span class="fw-bold">26/04/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14438</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-22">
															<span class="fw-bold">22/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-25">
															<span class="fw-bold">25/04/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14439</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-20">
															<span class="fw-bold">20/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-24">
															<span class="fw-bold">24/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14440</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-18">
															<span class="fw-bold">18/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-23">
															<span class="fw-bold">23/04/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14441</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-19">
															<span class="fw-bold">19/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-22">
															<span class="fw-bold">22/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14442</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-16">
															<span class="fw-bold">16/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-21">
															<span class="fw-bold">21/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14443</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-14">
															<span class="fw-bold">14/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-20">
															<span class="fw-bold">20/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14444</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14445</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14446</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-15">
															<span class="fw-bold">15/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-17">
															<span class="fw-bold">17/04/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14447</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-10">
															<span class="fw-bold">10/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-16">
															<span class="fw-bold">16/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14448</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-08">
															<span class="fw-bold">08/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-15">
															<span class="fw-bold">15/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14449</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end pe-0">
															<span class="fw-bold">$239.00</span>
														</td>
														<td class="text-end" data-order="2025-04-07">
															<span class="fw-bold">07/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-14">
															<span class="fw-bold">14/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14450</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-09">
															<span class="fw-bold">09/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-13">
															<span class="fw-bold">13/04/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14451</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-12">
															<span class="fw-bold">12/04/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14452</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-04">
															<span class="fw-bold">04/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-11">
															<span class="fw-bold">11/04/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14453</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14454</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-06">
															<span class="fw-bold">06/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-09">
															<span class="fw-bold">09/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14455</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-03">
															<span class="fw-bold">03/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-08">
															<span class="fw-bold">08/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14456</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14457</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-02">
															<span class="fw-bold">02/04/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-06">
															<span class="fw-bold">06/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14458</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-05">
															<span class="fw-bold">05/04/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14459</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-29">
															<span class="fw-bold">29/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-04-04">
															<span class="fw-bold">04/04/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14460</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14461</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14462</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-04-01">
															<span class="fw-bold">01/04/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14463</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-28">
															<span class="fw-bold">28/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-31">
															<span class="fw-bold">31/03/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14464</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-24">
															<span class="fw-bold">24/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-30">
															<span class="fw-bold">30/03/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14465</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14466</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-23">
															<span class="fw-bold">23/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-28">
															<span class="fw-bold">28/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14467</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end pe-0">
															<span class="fw-bold">$212.00</span>
														</td>
														<td class="text-end" data-order="2025-03-22">
															<span class="fw-bold">22/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-27">
															<span class="fw-bold">27/03/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14468</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-26">
															<span class="fw-bold">26/03/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14469</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-25">
															<span class="fw-bold">25/03/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14470</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-19">
															<span class="fw-bold">19/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-24">
															<span class="fw-bold">24/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14471</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-20">
															<span class="fw-bold">20/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-23">
															<span class="fw-bold">23/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14472</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-18">
															<span class="fw-bold">18/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-22">
															<span class="fw-bold">22/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14473</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-21">
															<span class="fw-bold">21/03/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14474</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-14">
															<span class="fw-bold">14/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-20">
															<span class="fw-bold">20/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14475</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-15">
															<span class="fw-bold">15/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-19">
															<span class="fw-bold">19/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14476</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14477</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-16">
															<span class="fw-bold">16/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-17">
															<span class="fw-bold">17/03/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14478</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-12">
															<span class="fw-bold">12/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-16">
															<span class="fw-bold">16/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14479</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-10">
															<span class="fw-bold">10/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-15">
															<span class="fw-bold">15/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14480</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end pe-0">
															<span class="fw-bold">$361.00</span>
														</td>
														<td class="text-end" data-order="2025-03-13">
															<span class="fw-bold">13/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-14">
															<span class="fw-bold">14/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14481</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-07">
															<span class="fw-bold">07/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-13">
															<span class="fw-bold">13/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14482</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-09">
															<span class="fw-bold">09/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-12">
															<span class="fw-bold">12/03/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14483</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-08">
															<span class="fw-bold">08/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-11">
															<span class="fw-bold">11/03/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14484</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">14485</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-03-05">
															<span class="fw-bold">05/03/2025</span>
														</td>
														<td class="text-end" data-order="2025-03-09">
															<span class="fw-bold">09/03/2025</span>
														</td>
