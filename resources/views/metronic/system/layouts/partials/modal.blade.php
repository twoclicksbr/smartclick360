                    ...
                    <div class="mh-300px scroll-y me-n7 pe-7">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="/assets/metronic/media/avatars/300-12.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="/assets/metronic/media/avatars/300-13.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="/assets/metronic/media/avatars/300-21.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                    ...
                    <div class="py-5">
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="/assets/metronic/media/illustrations/sketchy-1/1.png" alt=""
...
<div class="modal fade" tabindex="-1" id="modalCredential">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-1 col-12">
                            ...
                            <select class="form-select select2" name="is_master" required>
                        ...
                        <div class="col-md-2 col-12">
                            ...
                            <input type="date" class="form-control" id="dt_expiration" name="dt_expiration" required />
                        </div>

                        <div class="col-md-2 col-12">
                            <label class="form-label">Limite de Acesso:</label>
                            <input type="date" class="form-control" id="dt_limit_access" name="dt_limit_access" required readonly />
                        </div>
                    </div>
                </div>
