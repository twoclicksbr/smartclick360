...
<head>
    ...
    <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo7/index.html" rel="canonical" />
    ...
    <meta content="assets/metronic/media/app/og-image.png" name="twitter:image" />
    <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo7/index.html" property="og:url" />
    <meta content="en_US" property="og:locale" />
    <meta content="website" property="og:type" />
    <meta content="@keenthemes" property="og:site_name" />
    <meta content="Metronic - Tailwind CSS " property="og:title" />
    <meta content="" property="og:description" />
    <meta content="assets/metronic/media/app/og-image.png" property="og:image" />
    <link href="assets/metronic/media/app/apple-touch-icon.png" rel="apple-touch-icon" sizes="180x180" />
    <link href="assets/metronic/media/app/favicon-32x32.png" rel="icon" sizes="32x32" type="image/png" />
    <link href="assets/metronic/media/app/favicon-16x16.png" rel="icon" sizes="16x16" type="image/png" />
    <link href="assets/metronic/media/app/favicon.ico" rel="shortcut icon" />
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet" />
    <link href="assets/metronic/vendors/apexcharts/apexcharts.css" rel="stylesheet" />
...
<body
    class="antialiased flex h-full text-base text-foreground bg-background [--header-height-default:95px] data-kt-[sticky-header=on]:[--header-height:60px] [--header-height:var(--header-height-default)] [--header-height-mobile:70px]">
    <!-- Theme Mode -->
    <script>
                    ...
                    <div class="flex items-center gap-2.5">
                        <a href="html/demo7.html">
                            <img class="dark:hidden min-h-[34px]"
                                src="assets/metronic/media/app/mini-logo-circle-primary.svg" />
                            <img class="hidden dark:inline-block min-h-[34px]"
                                src="assets/metronic/media/app/mini-logo-circle-primary-dark.svg" />
                        </a>
                        <button class="lg:hidden kt-btn kt-btn-icon kt-btn-ghost"
                            data-kt-drawer-toggle="#mega_menu_container">
                        ...
                        <div class="flex items-stretch [--kt-reparent-mode:prepend] lg:[--kt-reparent-mode:prepend] [--kt-reparent-target:body] lg:[--kt-reparent-target:#megaMenuWrapper]"
                            ...
                            <div class="hidden lg:flex lg:items-stretch [--kt-drawer-enable:true] lg:[--kt-drawer-enable:false]"
                                ...
                                <div class="kt-menu flex-col lg:flex-row gap-5 lg:gap-7.5" data-kt-menu="true"
                                    ...
                                    <div class="kt-menu-item" data-kt-menu-item-offset="-80px, 10px"
                                        data-kt-menu-item-offset-rtl="80px, 10px"
                                                    ...
                                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                        ...
                                                        <div class="grid lg:grid-cols-2 lg:gap-5">
                                                            <div class="flex flex-col gap-0.5">
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/profiles/default.html"
                                                                        tabindex="0">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/profiles/creator.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/profiles/company.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/profiles/nft.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/profiles/blogger.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/profiles/crm.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/profiles/gamer.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                            ...
                                                            <div>
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/profiles/feeds.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/profiles/plain.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/profiles/modal.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                    ...
                                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                        ...
                                                        <div class="grid lg:grid-cols-2 lg:gap-5">
                                                            <div class="flex flex-col gap-0.5">
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/projects/3-columns.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/projects/2-columns.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/works.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/teams.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/network.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/activity.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/campaigns/card.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                            ...
                                                            <div>
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/campaigns/list.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/public-profile/empty.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-icon">
                                    ...
                                    <div class="kt-menu-item" data-kt-menu-item-offset="-320px, 10px"
                                        data-kt-menu-item-offset-rtl="320px, 10px" data-kt-menu-item-overflow="true"
                                        data-kt-menu-item-placement="bottom-start"
                                        data-kt-menu-item-placement-rtl="bottom-end"
                                        data-kt-menu-item-toggle="accordion|lg:dropdown"
                                        data-kt-menu-item-trigger="click|lg:hover">
                                                ...
                                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                            href="html/demo7/account/integrations.html">
                                                            <span class="kt-menu-icon">
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                            href="html/demo7/account/notifications.html">
                                                            <span class="kt-menu-icon">
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                            href="html/demo7/account/api-keys.html">
                                                            <span class="kt-menu-icon">
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                            href="html/demo7/account/appearance.html">
                                                            <span class="kt-menu-icon">
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                            href="html/demo7/account/invite-a-friend.html">
                                                            <span class="kt-menu-icon">
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                            href="html/demo7/account/activity.html">
                                                            <span class="kt-menu-icon">
                                                ...
                                                <div class="grid lg:grid-cols-5 gap-5">
                                                    <div class="flex flex-col">
                                                        ...
                                                        <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/home/get-started.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Get Started
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/home/user-profile.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        User Profile
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/home/company-profile.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Company Profile
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/home/settings-sidebar.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        With Sidebar
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/home/settings-enterprise.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Enterprise
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/home/settings-plain.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Plain
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/home/settings-modal.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Modal
                                                                    </span>
                                                    ...
                                                    <div class="flex flex-col">
                                                        ...
                                                        <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/billing/basic.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Basic Billing
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/billing/enterprise.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Enterprise
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/billing/plans.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Plans
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/billing/history.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Billing History
                                                                    </span>
                                                    ...
                                                    <div class="flex flex-col">
                                                        ...
                                                        <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/security/get-started.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Get Started
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/security/overview.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Security Overview
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/security/allowed-ip-addresses.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        IP Addresses
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/security/privacy-settings.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Privacy Settings
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/security/device-management.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Device Management
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/security/backup-and-recovery.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Backup & Recovery
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/security/current-sessions.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Current Sessions
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/security/security-log.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Security Log
                                                                    </span>
                                                    ...
                                                    <div class="flex flex-col">
                                                        ...
                                                        <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/members/team-starter.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Teams Starter
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/members/teams.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Teams
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/members/team-info.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Team Info
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/members/members-starter.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Members Starter
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/members/team-members.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Team Members
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/members/import-members.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Import Members
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/members/roles.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Roles
                                                                    </span>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/members/permissions-toggle.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/account/members/permissions-check.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-title grow-0">
                                                                        Persmissions - Check
                                                                    </span>
                                                    ...
                                                    <div class="grid lg:grid-cols-2 gap-5">
                                                        <div class="flex flex-col gap-5">
                                                            ...
                                                            <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/network/user-cards/mini-cards.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Mini Cards
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/network/user-cards/team-crew.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Team Crew
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/network/user-cards/nft.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Authors
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/network/user-cards/social.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            NFT Users
                                                                        </span>
                                                        ...
                                                        <div class="flex flex-col gap-5">
                                                            ...
                                                            <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/network/user-table/team-crew.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Team Crew
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/network/user-table/app-roster.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            App Roster
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/network/user-table/market-authors.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Market Authors
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/network/user-table/saas-users.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            SaaS Users
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/network/user-table/store-clients.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Store Clients
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/network/user-table/visitors.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Visitors
                                                                        </span>
                                    ...
                                    <div class="kt-menu-item" data-kt-menu-item-offset="-80px, 10px"
                                        data-kt-menu-item-offset-rtl="80px, 10px" data-kt-menu-item-overflow="true"
                                        data-kt-menu-item-placement="bottom-start"
                                        data-kt-menu-item-placement-rtl="bottom-end"
                                        data-kt-menu-item-toggle="accordion|lg:dropdown"
                                        data-kt-menu-item-trigger="click|lg:hover">
                                                ...
                                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                    ...
                                                    <div class="grid lg:grid-cols-2 lg:gap-5">
                                                        <div class="flex flex-col gap-0.5">
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/home.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/search-results-grid.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/search-results-list.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/product-details.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/shopping-cart.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/wishlist.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                                        <i class="ki-filled ki-heart">
                                                                        </i>
                                                        ...
                                                        <div>
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/checkout/order-summary.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/checkout/shipping-info.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/checkout/payment-method.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/checkout/order-placed.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/my-orders.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link"
                                                                    href="html/demo7/store-client/order-receipt.html"
                                                                    tabindex="0">
                                                                    <span class="kt-menu-icon">
                                                                        <i class="ki-filled ki-document">
                                                                        </i>
                                            ...
                                            <div class="flex flex-col lg:flex-row">
                                                    ...
                                                    <div class="grid lg:grid-cols-2 gap-5">
                                                        <div class="flex flex-col">
                                                            ...
                                                            <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/classic/sign-in.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Sign In
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/classic/sign-up.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Sign Up
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/classic/2fa.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            2FA
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/classic/check-email.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Check Email
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/classic/reset-password/enter-email.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Enter Email
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/classic/reset-password/check-email.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Check Email
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/classic/reset-password/change-password.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Change Password
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/classic/reset-password/password-changed.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Password is Changed
                                                                        </span>
                                                        ...
                                                        <div class="flex flex-col">
                                                            ...
                                                            <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/branded/sign-in.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Sign In
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/branded/sign-up.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Sign Up
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/branded/2fa.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            2FA
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/branded/check-email.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Check Email
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/branded/reset-password/enter-email.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Enter Email
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/branded/reset-password/check-email.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Check Email
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/branded/reset-password/change-password.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Change Password
                                                                        </span>
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link"
                                                                        href="html/demo7/authentication/branded/reset-password/password-changed.html"
                                                                        tabindex="0">
                                                                        <span class="kt-menu-title grow-0">
                                                                            Password is Changed
                                                                        </span>
                                                ...
                                                <div
                                                    ...
                                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                                href="html/demo7/authentication/welcome-message.html">
                                                                <span class="kt-menu-icon">
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                                href="html/demo7/authentication/account-deactivated.html">
                                                                <span class="kt-menu-icon">
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                                href="html/demo7/authentication/error-404.html">
                                                                <span class="kt-menu-icon">
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                                href="html/demo7/authentication/error-500.html">
                                                                <span class="kt-menu-icon">
                                        ...
                                        <div class="kt-menu-dropdown kt-menu-default py-2.5 w-full max-w-[220px]">
                                            ...
                                            <div class="kt-menu-item" data-kt-menu-item-placement="right-start"
                                                ...
                                                <div
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="https://devs.keenthemes.com"
                                                            tabindex="0">
                                                            <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link" href="https://keenthemes.com/contact"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                ...
                <div class="flex items-center flex-wrap gap-3">
                    ...
                    <div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px"
                        ...
                        <div class="cursor-pointer size-[34px] rounded-full inline-flex items-center justify-center relative text-lg font-medium border border-input bg-accent/60 text-foreground"
                            ...
                            S
                            <svg class="absolute left-6 -top-0.5 text-primary size-3" fill="none"
                                height="16" viewbox="0 0 15 16" width="15"
                            ...
                            <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
                                <div class="flex items-center gap-2">
                                    <img alt=""
                                        ...
                                        src="assets/metronic/media/avatars/300-2.png" />
                                    <div class="flex flex-col gap-1.5">
                                    ...
                                    <button class="kt-dropdown-menu-toggle py-1" data-kt-dropdown-toggle="true">
                                        ...
                                        <span class="ms-auto kt-badge kt-badge-stroke shrink-0">
                                            ...
                                            <img alt="" class="inline-block size-3.5 rounded-full"
                                                src="assets/metronic/media/flags/united-states.svg" />
                                        </span>
                                    </button>
                                        ...
                                        <ul class="kt-dropdown-menu-sub">
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=rtl">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="assets/metronic/media/flags/saudi-arabia.svg" />
                                                        <span class="kt-menu-title">
                                                            Arabic(Saudi)
                                                        </span>
                                                    </span>
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="assets/metronic/media/flags/spain.svg" />
                                                        <span class="kt-menu-title">
                                                            Spanish
                                                        </span>
                                                    </span>
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="assets/metronic/media/flags/germany.svg" />
                                                        <span class="kt-menu-title">
                                                            German
                                                        </span>
                                                    </span>
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="assets/metronic/media/flags/japan.svg" />
                                                        <span class="kt-menu-title">
                                                            Japanese
                                                        </span>
                                                    </span>
            ...
            <div class="kt-container-fixed">
                ...
                <div class="flex items-center justify-between flex-wrap gap-2 la:gap-5 my-5">
                    ...
                    <div class="flex items-center flex-wrap gap-1.5 lg:gap-3.5">
                        <a class="kt-btn kt-btn-outline" href="html/demo7/account/home/get-started.html">
                            <i class="ki-filled ki-exit-down text-base!">
                            </i>
                            Export
                        </a>
                        <div class="kt-menu kt-menu-default" data-kt-menu="true">
                            <div class="kt-menu-item" data-kt-menu-item-offset="0, 0"
                ...
                <div class="grid gap-5 lg:gap-7.5">
                    ...
                    <div class="grid lg:grid-cols-3 gap-y-5 lg:gap-7.5 items-stretch">
                        <div class="lg:col-span-2">
                            <div class="grid md:grid-cols-2 gap-5 lg:gap-7.5 h-full items-stretch">
                                <style>
                                    .channel-stats-bg {
                                        background-image: url('assets/metronic/media/images/2600x1600/bg-3.png');
                                    }

                                    .dark .channel-stats-bg {
                                        background-image: url('assets/metronic/media/images/2600x1600/bg-3-dark.png');
                                    }
                                </style>
                                <div
                                    ...
                                    <div class="mb-4">
                                        <a class="kt-link" href="html/demo7/account/members/team-info.html">
                                            View page
                                            <i class="ki-filled ki-right text-xs">
                                            </i>
                                        </a>
                                ...
                                <div
                                    ...
                                    <div class="mb-4">
                                        <a class="kt-link" href="html/demo7/account/security/security-log.html">
                                            View page
                                            <i class="ki-filled ki-right text-xs">
                                            </i>
                                        </a>
                                ...
                                <div
                                    ...
                                    <div class="mb-4">
                                        <a class="kt-link" href="html/demo7/account/billing/basic.html">
                                            View page
                                            <i class="ki-filled ki-right text-xs">
                                            </i>
                                        </a>
                                ...
                                <div
                                    ...
                                    <div class="mb-4">
                                        <a class="kt-link" href="html/demo7/account/members/roles.html">
                                            View page
                                            <i class="ki-filled ki-right text-xs">
                                            </i>
                                        </a>
                                    ...
                                    <div class="kt-menu" data-kt-menu="true">
                                        <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px"
                                            ...
                                            <div class="kt-menu-dropdown kt-menu-default w-full max-w-[200px]"
                                                ...
                                                <div class="kt-menu-item">
                                                    <a class="kt-menu-link" href="html/demo7/account/activity.html">
                                                        <span class="kt-menu-icon">
                                ...
                                <div class="kt-card-content flex flex-col gap-2 px-5 lg:px-7.5 pt-5">
                                    ...
                                    <div class="kt-toggle-group flex">
                                        ...
                                        <label class="kt-btn" data-kt-chart="my_balance_chart3">
                                            Month
                                            <input checked="" name="date-range" type="radio"
                                                value="month" />
                                        </label>
                    ...
                    <div class="grid lg:grid-cols-3 gap-5 lg:gap-7.5 items-stretch">
                        <div class="lg:col-span-2">
                            <style>
                                .entry-callout-bg {
                                    background-image: url('assets/metronic/media/images/2600x1600/2.png');
                                }

                                .dark .entry-callout-bg {
                                    background-image: url('assets/metronic/media/images/2600x1600/2-dark.png');
                                }
                            </style>
                                        ...
                                        <div class="flex -space-x-2">
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-10"
                                                    src="assets/metronic/media/avatars/300-4.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-10"
                                                    src="assets/metronic/media/avatars/300-1.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-10"
                                                    src="assets/metronic/media/avatars/300-2.png" />
                        ...
                        <div class="lg:col-span-1">
                            <div class="kt-card h-full">
                                ...
                                <label class="kt-card-group flex items-center justify-between py-4 gap-2.5">
                                    ...
                                    <input class="kt-radio" name="sharing-setting" type="radio"
                                        value="2" />
                                </label>
                                <label class="kt-card-group flex items-center justify-between py-4 gap-2.5">
                                    <div class="flex flex-col justify-center gap-1.5">
                                ...
                                <div class="kt-card-content grid gap-5 lg:gap-7.5 lg:py-7.5 py-5">
                                    <div class="grid gap-5">
                                        <div
                                            ...
                                            <div class="flex items-center flex-wrap gap-3.5">
                                                <img alt="" class="size-8 shrink-0"
                                                    src="assets/metronic/media/brand-logos/google-webdev.svg" />
                                                <div class="flex flex-col">
                                            ...
                                            <div class="flex items-center gap-2 lg:gap-5">
                                                <input checked="" class="kt-switch kt-switch-sm"
                                                    type="checkbox" value="1" />
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center flex-wrap gap-3.5">
                                                <img alt="" class="size-8 shrink-0"
                                                    src="assets/metronic/media/brand-logos/equacoin.svg" />
                                                <div class="flex flex-col">
                                                    <div class="flex items-center gap-1.5">
                                                        <a class="text-sm font-medium text-mono hover:text-primary"
                                                            href="#">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center flex-wrap gap-3.5">
                                                <img alt="" class="size-8 shrink-0"
                                                    src="assets/metronic/media/brand-logos/evernote.svg" />
                                                <div class="flex flex-col">
                                                    <div class="flex items-center gap-1.5">
                                                        <a class="text-sm font-medium text-mono hover:text-primary"
                                                            href="#">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center flex-wrap gap-3.5">
                                                <img alt="" class="size-8 shrink-0"
                                                    src="assets/metronic/media/brand-logos/inferno.svg" />
                                                <div class="flex flex-col">
                                                    <div class="flex items-center gap-1.5">
                                                        <a class="text-sm font-medium text-mono hover:text-primary"
                                                            href="#">
                            ...
                            <div class="kt-card h-full">
                                ...
                                <div class="kt-card-content flex flex-col gap-5">
                                    ...
                                    <div class="kt-input-group">
                                        <input class="kt-input" placeholder="Block new user" type="text"
                                            value="">
                                    ...
                                    <div class="flex flex-col gap-5">
                                            ...
                                            <div class="flex items-center gap-2.5">
                                                <div class="">
                                                    <img class="h-9 rounded-full"
                                                        src="assets/metronic/media/avatars/gray/1.png" />
                                                </div>
                                                <div class="flex flex-col gap-0.5">
                                        ...
                                        <div class="flex items-center justify-between gap-2.5">
                                            <div class="flex items-center gap-2.5">
                                                <div class="">
                                                    <img class="h-9 rounded-full"
                                                        src="assets/metronic/media/avatars/gray/2.png" />
                                                </div>
                                                <div class="flex flex-col gap-0.5">
                                                    <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                                        href="html/demo7/public-profile/teams.html">
                                        ...
                                        <div class="flex items-center justify-between gap-2.5">
                                            <div class="flex items-center gap-2.5">
                                                <div class="">
                                                    <img class="h-9 rounded-full"
                                                        src="assets/metronic/media/avatars/gray/3.png" />
                                                </div>
                                                <div class="flex flex-col gap-0.5">
                                                    <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                                        href="html/demo7/public-profile/teams.html">
                                        ...
                                        <div class="flex items-center justify-between gap-2.5">
                                            <div class="flex items-center gap-2.5">
                                                <div class="">
                                                    <img class="h-9 rounded-full"
                                                        src="assets/metronic/media/avatars/gray/4.png" />
                                                </div>
                                                <div class="flex flex-col gap-0.5">
                                                    <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                                        href="html/demo7/public-profile/teams.html">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="flex -space-x-2">
                                                                    <div class="flex">
                                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                            src="assets/metronic/media/avatars/300-24.png" />
                                                                    </div>
                                                                    <div class="flex">
                                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                            src="assets/metronic/media/avatars/300-7.png" />
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                        ...
                        <div class="lg:col-span-1">
                            <div class="kt-card h-full">
                                ...
                                <div class="kt-card-group flex items-center justify-between py-4 gap-2.5">
                                    ...
                                    <input class="kt-switch kt-switch-sm" name="param" type="checkbox"
                                        value="1">
                                    </input>
                                </div>
                                <div class="kt-card-group flex items-center justify-between py-4 gap-2.5">
                                            ...
                                            <div class="flex items-center grow gap-2">
                                                <div
                                                    ...
                                                    <img alt="" class="size-6 shrink-0"
                                                        src="assets/metronic/media/brand-logos/jira.svg" />
                                                </div>
                                                <div class="flex flex-col gap-0.5">
                                        ...
                                        <div class="kt-menu-link flex items-center jistify-between gap-2">
                                            ...
                                            <div class="flex justify-end shrink-0">
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="assets/metronic/media/avatars/300-14.png" />
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="assets/metronic/media/avatars/300-12.png" />
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="assets/metronic/media/avatars/300-9.png" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="kt-menu-link flex justify-between gap-2">
                                                <div class="flex items-center gap-2.5">
                                                    <img alt="" class="rounded-full size-9 shrink-0"
                                                        src="assets/metronic/media/avatars/300-3.png" />
                                                    <div class="flex flex-col">
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="assets/metronic/media/avatars/300-6.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="assets/metronic/media/avatars/300-3.png" />
                                            ...
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="assets/metronic/media/avatars/300-8.png" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    <div class="flex items-center grow gap-2">
                                        <div
                                            class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
                                            <img alt="" class="size-6 shrink-0"
                                                src="assets/metronic/media/brand-logos/gitlab.svg" />
                                        </div>
                                        <div class="flex flex-col gap-0.5">
                                            <a class="text-sm font-semibold text-mono hover:text-primary"
                                                href="#">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="assets/metronic/media/avatars/300-18.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="assets/metronic/media/avatars/300-17.png" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            ...
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="assets/metronic/media/avatars/300-20.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="assets/metronic/media/avatars/300-21.png" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="grid gap-1">
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex justify-between gap-2">
                                        <div class="flex items-center gap-2.5">
                                            <img alt="" class="rounded-full size-9 shrink-0"
                                                src="assets/metronic/media/avatars/300-11.png" />
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary mb-px"
                                                    href="#">
                                                    Jacob Jones
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex justify-between gap-2">
                                        <div class="flex items-center gap-2.5">
                                            <img alt="" class="rounded-full size-9 shrink-0"
                                                src="assets/metronic/media/avatars/300-5.png" />
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary mb-px"
                                                    href="#">
                                                    TLeslie Alexander
                        ...
                        <div class="kt-menu kt-menu-default px-0.5 flex-col">
                            <div class="grid">
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="assets/metronic/media/file-types/pdf.svg" />
                                            <div class="flex flex-col">
                                                <span
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="assets/metronic/media/file-types/doc.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    Report-v1.docx
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="assets/metronic/media/file-types/javascript.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    Framework-App.js
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="assets/metronic/media/file-types/ai.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    Framework-App.js
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="assets/metronic/media/file-types/php.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    appController.js
                        ...
                        <div class="flex flex-col text-center py-9 gap-5">
                            <div class="flex justify-center">
                                <img alt="image" class="dark:hidden max-h-[113px]"
                                    src="assets/metronic/media/illustrations/33.svg" />
                                <img alt="image" class="light:hidden max-h-[113px]"
                                    src="assets/metronic/media/illustrations/33-dark.svg" />
                            </div>
                            <div class="flex flex-col gap-1.5">
                ...
                <div class="flex flex-col gap-5 p-5">
                    ...
                    <div class="flex flex-col gap-3.5">
                        <label class="kt-form-label flex items-center gap-2.5">
                            <input checked="" class="kt-radio radio-sm" name="report-option" type="radio"
                                value="1" />
                            <div class="flex flex-col gap-0.5">
    ...
    <script src="assets/metronic/vendors/ktui/ktui.min.js"></script>
    <script src="assets/metronic/vendors/apexcharts/apexcharts.min.js"></script>
    <script src="assets/metronic/js/widgets/general.js"></script>
    <!-- End of Scripts -->
</body>
